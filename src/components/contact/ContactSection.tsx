    ...
    <section className="max-w-3xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
        ...
        <div>
          ...
          <p className="mt-3 text-base sm:text-lg text-gray-600">{t.contact.subtitle}</p>

          <div className="mt-4 flex items-center gap-2 text-sm">
            <Envelope className="size-4 text-gray-500" />
            <Link href="mailto:antonliakhovskii@gmail.com">antonliakhovskii@gmail.com</Link>
          </div>
        </div>
      </div>
      ...
      <Card className="w-full">
        <Card.Header className="flex items-start gap-3">
          ...
          <div>
            ...
            <Card.Description>{t.contact.linkedin.description}</Card.Description>
          </div>
        </Card.Header>
